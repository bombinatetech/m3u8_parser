defmodule M3u8Parser do
  ...
  def parse_segment_file(acc, line) do
    pend(acc, title: trim_trailing_new_line(line))
  end
  ...
  defp is_end_match?(line, match), do: String.ends_with?(trim_trailing_new_line(line), match)
